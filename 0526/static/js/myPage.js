...
function changePW() {
    ...
    wrap.replaceChild(changeBtn, document.getElementsByClassName("pw")[0]);
...
function changeNick() {
    ...
    wrap.replaceChild(changeBtn, document.getElementsByClassName("nick")[0]);
